...
const Main = () => {
    ...
    return (
        <div className="main">
            <div className="nav">
                <p>RigKatha</p>
                {/* Toggle the login component on clicking the user icon */}
                ...
                <div className="main-container">
                    ...
                    <div className="main-bottom">
                        ...
                        <div className="bottom-info">
                            <p>RigKatha may display inaccurate info, including about people, so double-check its responses. Your privacy & Gemini Apps</p>
                        </div>
                    </div>
                </div>
            )}
